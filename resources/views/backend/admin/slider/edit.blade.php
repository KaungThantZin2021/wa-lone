...
@section('title', 'Edit Slider | ' . config('app.name'))
...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <div class="card dark:tw-bg-slate-800">
            <div class="card-body">
                {!! Form::model($slider, ['route' => ['admin.slider.update', $slider->id], 'files' => true, 'id' => 'sliderForm', 'method' => 'put']) !!}

                @include('backend.admin.slider.partials._form', ['form_type' => 'edit'])
