...
@section('title', 'Showroom | ' . config('app.name'))
@section('showroom-selected', 'selected')
@section('css')
...
@section('content')
                ...
                <div class="d-flex align-items-center">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb m-0 p-0">
                            ...
                            <li class="breadcrumb-item"><a href="{{ route('admin.role.index') }}">Showroom</a></li>
                        </ol>
                    </nav>
                </div>
            </div>
    ...
    <div class="container-fluid">
        <div class="mb-3">
            ...
            @can('create_showroom')
            <a href="{{ route('admin.showroom.create') }}" class="btn btn-primary"><i class="fas fa-plus-circle"></i> Create Showroom</a>
            @endcan
        ...
        <div class="card">
            <div class="card-body dark:tw-bg-slate-800">
                <div class="table-responsive">
                    <table class="table table-bordered" id="showrooms-table">
                        <thead>
                            <tr class="bg-primary">
...
{{-- <script>
    $(document).ready(function () {
        var table = $('#showrooms-table').DataTable({
            processing: true,
            serverSide: true,
            dom: 'Bfrtip',
            buttons: [
            ...
            ajax: {
                url: "{{ route('admin.showroom.index') }}",
                data: (d) => {
