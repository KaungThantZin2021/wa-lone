    ...
    <nav class="sidebar sidebar-offcanvas fixed-left" id="sidebar">
        <div class="sidebar-brand-wrapper d-none d-lg-flex align-items-center justify-content-center fixed-top">
            <a class="sidebar-brand brand-logo" href="">
                ...
                <h3 class="text-left text-light">{{ config('app.name') }}</h3>
            </a>
            <a class="sidebar-brand brand-logo-mini" href="index.html">
                {{-- <img src="assets/images/logo-mini.svg" alt="logo" /> --}}
                <h3 class="text-left text-light">ဝလုံး</h3>
            </a>
        </div>
        <ul class="nav">
                ...
                <div class="profile-desc">
                    <div class="profile-pic">
                        ...
                        <div class="profile-name">
                            <h5 class="mb-0 font-weight-normal">{{ auth()->guard('admin_user')->user()->name }}</h5>
            ...
            <li class="nav-item menu-items @yield('d-active')">
            ...
            <li class="nav-item menu-items @yield('admin-user-active')">
            ...
            <li class="nav-item menu-items @yield('user-active')">
                <a class="nav-link" href="{{ route('admin.user.index') }}">
                    {{-- <a href="{{ route('admin.user.index') }}"></a> --}}
                    <span class="menu-icon">
